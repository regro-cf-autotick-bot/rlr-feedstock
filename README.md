...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/rlr-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14618&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/rlr-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `rlr` can be installed with:

```
conda install rlr
```

It is possible to list all of the versions of `rlr` available on your platform with:
